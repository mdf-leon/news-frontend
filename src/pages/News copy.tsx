...
// function NewsList(
//   props: { news: IArticle[], user: } & React.ComponentPropsWithoutRef<"div">
// ) {
//   const { news, ...rest } = props;
//   if (news) return <div {...rest}>{news.map((article, index) => <Article article={article} index={index} user={user} />)}</div>;
//   return null;
// }

// function Article(props: {article: IArticle, user: IUser, index?: number | undefined}) {
